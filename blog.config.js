...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '小王的blog', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '又菜又爱玩🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://uaicode.com', // 网站地址
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://ghproxy.020415.xyz/https://raw.githubusercontent.com/27296/picx-images-hosting/master/aakrl-8wnzi-001.5q7cup0aq5.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '豫ICP备20010535', // 备案号 闽ICP备XXXXXXX
  ...
  TianliGPT_JS:
    ...
    'https://ai0.uaicode.com/js/custom.js',
  TianliGPT_KEY: process.env.NEXT_PUBLIC_TIANLI_GPT_KEY || 'sss',
